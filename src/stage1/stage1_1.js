...
var stage1_1game = cc.Layer.extend({
  init: function(){
    ...
    // ラウンドラベル表示
    var roundlabel = new cc.LabelTTF("ROUND - 1/2", "Arial", 10);
    ...
    enemy[0] = new Enemy(size.width * 0.6, size.height * 0.4, -50, 50, 2, 2);
    enemys_layer.addChild(enemy[0]);
    enemy[1] = new Enemy(size.width * 0.2, size.height * 0.6, 90, -30, 3.3, 3.3);
