var Stage3_1Scene = cc.Scene.extend({
  onEnter:function () {
        this._super();
        stage3_1gamelayer = new stage3_1game();
        stage3_1gamelayer.init();
        this.addChild(stage3_1gamelayer);
    }
});

var stage3_1game = cc.Layer.extend({
  init: function(){
    this._super();
    round_flg = 31;
    touch_count = 0;
