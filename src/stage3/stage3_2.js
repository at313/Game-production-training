...
var stage3_2game = cc.Layer.extend({
  init: function(){
    this._super();
    round_flg = 32;
    touch_count = 0;
    ...
    // ステージラベル表示
    var stagelabel = new cc.LabelTTF("STAGE - 3", "Arial", 10);
    ...
    // ラウンドラベル表示
    var roundlabel = new cc.LabelTTF("ROUND - 2/3", "Arial", 10);
    ...
    enemy[2] = new Enemy_Ace(size.width * 0.2, size.height * 0.54, 90, -20, 1.5, 1.5);
    enemys_layer.addChild(enemy[2]);
    enemy[3] = new Enemy_Ace(size.width * 0.8, size.height * 0.66, -110, 10, 1.5, 1.5);
